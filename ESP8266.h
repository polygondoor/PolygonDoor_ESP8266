...
class ESP8266 {
 public:
     ...
     * By Etienne. 
     *
     * Starts SOftserial at 115200 .. and soft-sets it to 9600
     * 
     * @retval true - alive.
     * @retval false - dead.
     */
    ...
    /**
     *
     * Added by Etienne, check if we are already on wireless
     */
    bool checkAP(void);
 ...
 private:
    ...
    void sATCIPSENDSingleNoRcv(const uint8_t *buffer, uint32_t len);
